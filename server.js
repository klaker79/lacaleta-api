...
app.get('/api/monthly/summary', authenticateToken, async (req, res) => {
    try {
        ...
        // Lógica simplificada: en una refactorización real, esto iría a un servicio dedicado
        // Aquí retornamos una estructura básica para que el frontend no rompa
        const result = {
        ...
        // TODO: Implementar agregaciones SQL reales para reporte mensual
